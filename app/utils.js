define( ['jquery' ],
	    ...
	    utils.sp = getSpotifyApi(1);
	    utils.auth = utils.sp.require('sp://import/scripts/api/auth');
            ...
            utils.dfdQuery = function( searchType, ctx, query, sort, page ) {
                ...
                if(!(query==undefined || query == "")){
                    ...
                    utils.loadPrompt( 'Connecting to Facebook' );
            ...
            utils.fetchFoursquareToken = function( ctx ){

		    mobileSearch.utils.auth.showAuthenticationDialog('http://walkmanapi.dev/auth/foursquare', 'http://walkmanapi.dev/vibemakers', 
		    {
